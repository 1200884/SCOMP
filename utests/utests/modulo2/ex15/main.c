...
void test_Case1()
{ 
    run_test(8000, -8000, 40, -10, 6399996); 
}

void test_Case2()
{ 
    run_test(3000, -5000, 8000, 70, -214171); 
}

void test_Case3()
{ 
    run_test(1000, 1000, 1000, 10, 100100); 
}

void test_Case4()
{ 
    run_test(50, 5, 50005, -9, -5583); 
}

void test_Case5()
{ 
    run_test(50000, -50, 6, 7, -357142); 
}
