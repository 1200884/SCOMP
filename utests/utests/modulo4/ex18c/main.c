...
void test_Four()
{ 
    run_test((int[]){0,0xffffffff,0xff,0xff0fffff,0xff8fffff,0xff7fffff,0x700000,0x800000},8,
		     (int[]){0,0xff0fffff,0xff,0xff0fffff,0xff7fffff,0xff7fffff,0x700000,0x700000}); 
}
